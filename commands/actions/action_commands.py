...
class DTStartGameCommand(BaseCommand):
    ...
    command_pattern = r"^/(开始|start)(?:\s+(傲娇|天真|妖媚|害羞|高冷|温柔|活泼|知性|病娇|无口|姐姐系|元气|小恶魔|文静|女王|受虐|淫乱|tsundere|innocent|seductive|shy|cold|gentle|lively|intellectual|yandere|kuudere|oneesan|genki|mesugaki|dandere|sadistic|masochistic|bitch))?$"
    ...
    async def execute(self) -> Tuple[bool, str, bool]:
        ...
        if personality_input:
            ...
            type_map = {
                ...
                "活泼": "lively", "lively": "lively",
                "知性": "intellectual", "intellectual": "intellectual",
                "病娇": "yandere", "yandere": "yandere",
                "无口": "kuudere", "kuudere": "kuudere",
                "姐姐系": "oneesan", "oneesan": "oneesan",
                "元气": "genki", "genki": "genki",
                "小恶魔": "mesugaki", "mesugaki": "mesugaki",
                "文静": "dandere", "dandere": "dandere",
                "女王": "sadistic", "sadistic": "sadistic",
                "受虐": "masochistic", "masochistic": "masochistic",
                "淫乱": "bitch", "bitch": "bitch"
            }
...
class DTRestartCommand(BaseCommand):
    ...
    async def execute(self) -> Tuple[bool, str, bool]:
        ...
        from ...systems.mechanics.confirmation_manager import ConfirmationManager
...
可用人格: 傲娇、天真、妖媚、害羞、高冷、温柔、活泼、知性、病娇、无口、姐姐系、元气、小恶魔、文静、女王、受虐、淫乱
""".strip())
