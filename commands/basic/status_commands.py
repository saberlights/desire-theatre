...
class DTQuickStatusCommand(BaseCommand):
    ...
    async def execute(self) -> Tuple[bool, str, bool]:
        ...
        from ...systems.relationship.evolution_system import EvolutionSystem
...
class DTStatusCommand(BaseCommand):
    ...
    async def execute(self) -> Tuple[bool, str, bool]:
        ...
        time_modifier = DynamicMoodSystem.get_time_modifier()
        mood_display = DynamicMoodSystem.get_mood_display(current_mood, time_modifier)
    ...
    async def _show_main_help(self):
        ...
        try:
            ...
            sections = [
                ("🎮 核心", [
                    "/开始 人格 - 创建角色",
                    "  人格: 傲娇|天真|妖媚|害羞|高冷|温柔|活泼|知性|病娇|无口|姐姐系|元气|小恶魔|文静|女王|受虐|淫乱",
                    "/看 - 详细状态 | /快看 - 快速状态",
                    "/重开 - 重置游戏",
                    "/聊天 内容 - 自由对话"
                ]),
    ...
    async def _show_commands_help(self):
        ...
        try:
            ...
            sections = [
                ("核心管理命令", [
                    "/开始 <人格> - 创建新角色",
                    "  可选人格: 傲娇/天真/妖媚/害羞/高冷/温柔/活泼/知性/病娇/无口/姐姐系/元气/小恶魔/文静/女王/受虐/淫乱",
                    "  示例: /开始 傲娇",
                    "/看 - 查看角色详细状态",
                    "/快看 - 快速查看核心属性",
                    "/重开 - 重置游戏(需二次确认)",
